...
public class MainViewModel implements MainViewModelContract.ViewModel,
    ...
    public ObservableInt howToConnectDeviceTextVisibility;
    ...
    public MainViewModel(@NonNull Context context,
        ...
        if (checkForSavedBluetoothDevices()) {
            howToConnectDeviceTextVisibility = new ObservableInt(View.GONE);
        } else {
            howToConnectDeviceTextVisibility = new ObservableInt(View.VISIBLE);
        }
    }
